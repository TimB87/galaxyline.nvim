  ...
  ModeNum = { -- {{{2
    ...
    provider = function()
      vim.api.nvim_command(
        'hi GalaxyModeNum guibg=' .. mode_color[vim.fn.mode()]
      )
...
gls.left[2] = {
  BufSep = { -- {{{2
    ...
    provider = function()
      vim.api.nvim_command(
        'hi GalaxyBufSep guibg=' .. mode_color[vim.fn.mode()]
      )
      return '█'
    end,
  },
...
gls.left[5] = {
  FileSep = { -- {{{2
    ...
    provider = function()
      vim.api.nvim_command(
        'hi GalaxyFileSep guibg=' .. mode_color[vim.fn.mode()]
      )
      return ' '
    end,
  },
...
gls.left[6] = {
  FileEF = { -- {{{2
    ...
    provider = function()
      ...
      vim.api.nvim_command(
        'hi GalaxyFileEF guibg=' .. mode_color[vim.fn.mode()]
      )
...
gls.right[0] = {
  LspClient = { -- {{{2
    ...
    provider = function()
      ...
      vim.api.nvim_command(
        'hi GalaxyLspClient guifg=' .. mode_color[vim.fn.mode()]
      )
...
gls.right[5] = {
  LineSep = { -- {{{2
    ...
    provider = function()
      vim.api.nvim_command(
        'hi GalaxyLineSep guibg=' .. mode_color[vim.fn.mode()]
      )
      return ' '
    end,
  },
...
gls.right[6] = {
  LineInfo = { -- {{{2
    ...
    provider = function()
      ...
      vim.api.nvim_command(
        'hi GalaxyLineInfo guibg=' .. mode_color[vim.fn.mode()]
      )
      return '☰ '
        .. cursor[1]
        .. '/'
