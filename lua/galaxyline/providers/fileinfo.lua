...
fileinfo.get_current_file_path = function(modified_icon, readonly_icon)
  ...
  local path_to_file =
    vim.split(vim.fn.fnamemodify(vim.fn.expand '%', ':~:.'), file_sep)
      ...
      if i == 1 then
        if path_to_file[#path_to_file - max_dirs] == nil then
          file_with_path = file_with_path
            .. '/'
            .. path_to_file[#path_to_file - (#path_to_file - 1)]
        else
          file_with_path = file_with_path
            .. '/'
            .. path_to_file[#path_to_file - max_dirs]
        end
      else
        file_with_path = file_with_path
          .. '/'
          .. path_to_file[#path_to_file - (i - 1)]
      end
    else
