...
extensions.vista_nearest = function(vista_icon)
  local has_vista, vista_info =
    pcall(vim.api.nvim_buf_get_var, 0, 'vista_nearest_method_or_function')
...
extensions.vimtex_status = function(
  icon_main,
  icon_sub_main,
  icon_sub_local,
  icon_compiled,
  ...
  local has_vt_local, vt_local =
    pcall(vim.api.nvim_buf_get_var, 0, 'vimtex_local')
